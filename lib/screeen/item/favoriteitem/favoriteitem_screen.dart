...
class FavoriteScreen extends BaseView<FavoriteController> {
  ...
  Widget vBuilder(BuildContext context) {
    return Scaffold(
      ...
      body: controller.favoriteist == null || controller.favoriteist!.isEmpty
          ? Material(
                            ...
                            children: [
                              ...
                              controller.favoriteist != null
                                  ? ListView.builder(
                                      ...
                                      shrinkWrap: true,
                                      itemCount: controller.favoriteist?.length,
                                      itemBuilder:
                                          (BuildContext context, index) {
                                        var loc =
                                            controller.favoriteist?[index];
                                        var dates = loc?.date;
                                        var id = loc?.uid;
                                        print(">>>>>>> loc id ${id}");
